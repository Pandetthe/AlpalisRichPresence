...
class AlpalisRichPresence {
  ...
  initialize() {
	...
	this.currentDetails = "SilesiaCounty - RolePlay";
	this.currentState = "| discord.alpalis.eu |";
	this.currentLargeImageKey = "big_logo";
	this.currentSmallImageKey = "small_logo";
	this.currentLargeImageText = "Alpalis Servers";
	this.currentSmallImageText = "Unturned";
    this.rpcClientInfo = {};
  ...
  async startRichPresence() {
    ...
    this.currentTimeout = setTimeout(async () => {
      ...
      this.client.updatePresence({
      	details: this.currentDetails || undefined,
      	state: this.currentState || undefined,
      	largeImageKey: this.currentLargeImageKey || undefined,
      	smallImageKey: this.currentSmallImageKey || undefined,
      	largeImageText: this.currentLargeImageText || undefined,
      	smallImageText: this.currentSmallImageText || undefined
      });
    }, 5000);
  }
  updateRichPresence() {
  ...
  buildActivityObject() {
    ...
    if (this.currentDetails) {
      activityObject.args.activity.details = this.currentDetails;
    }
    if (this.currentState) {
      activityObject.args.activity.state = this.currentState;
    }
    if (this.currentLargeImageKey) {
      activityObject.args.activity.assets.large_image = this.currentLargeImageKey;
      if (this.currentLargeImageText) {
        activityObject.args.activity.assets.large_text = this.currentLargeImageText;
      }
    }
    if (this.currentSmallImageKey) {
      activityObject.args.activity.assets.small_image = this.currentSmallImageKey;
      if (this.currentSmallImageText) {
        activityObject.args.activity.assets.small_text = this.currentSmallImageText;
      }
    }
